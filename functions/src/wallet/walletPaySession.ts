...
export const payFromWallet = functions.https.onCall(async (data, context) => {
  ...
  return db.runTransaction(async (tx) => {
    ...
    tx.set(sessionRef, {
      ...
      guardianId: req.guardianId ?? studentId,
      guardianName: req.guardianName ?? null,
      studentProfileId: req.studentProfileId ?? null,
      studentProfileName: req.studentProfileName ?? req.studentName ?? null,
      studentProfileGender: req.studentProfileGender ?? null,
      studentProfileBirthDate: req.studentProfileBirthDate ?? null,
      studentAge: req.studentAge ?? null,
      ...
      subscriptionId,
      studentCountryCode: req.studentCountryCode ?? null,
      studentCountryName: req.studentCountryName ?? null,
      displayCurrencyCode: req.displayCurrencyCode ?? null,
      displayCurrencyLabel: req.displayCurrencyLabel ?? null,
      displayAmount: req.displayAmount ?? null,
      fxRateToEGP: req.fxRateToEGP ?? null,
      chargedAmountEGP: req.chargedAmountEGP ?? null,
      sessionDurationMinutes: req.sessionDurationMinutes ?? null,
      studentPhone: req.studentPhone ?? null,
      mohaffezPhone: req.mohaffezPhone ?? null,
      imamAddressText: req.imamAddressText ?? null,
      imamAddressLat: req.imamAddressLat ?? null,
      imamAddressLng: req.imamAddressLng ?? null,

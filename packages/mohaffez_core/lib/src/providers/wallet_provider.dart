...
final walletProvider =
    StreamProvider.family<WalletModel, ({String userId, WalletOwnerType ownerType})>(
  (ref, params) => ref
...
final walletTransactionsProvider =
  ...
  (ref, userId) =>
      ref.read(walletRepositoryProvider).watchTransactions(userId),
);

/// All payout requests for a teacher (any status).
final payoutRequestsProvider =
    StreamProvider.family<List<PayoutRequestModel>, String>(
  (ref, mohaffezId) =>

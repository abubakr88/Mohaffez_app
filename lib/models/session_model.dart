...
extension MistakeTypeExtensions on MistakeType {
  /// Get Arabic label for mistake type
  ...
  String get description {
    switch (this) {
      case MistakeType.tajweed:
        return 'خطأ في تطبيق أحكام التجويد';
      case MistakeType.pronunciation:
        return 'خطأ في نطق الحروف أو الكلمات';
      case MistakeType.reading:
        return 'قراءة كلمة أو آية بشكل خاطئ';
      case MistakeType.skip:
        return 'تجاوز كلمة أو آية';
      case MistakeType.addition:
        return 'إضافة كلمة أو حرف زائد';
      case MistakeType.other:
        return 'خطأ آخر';
    }
  }

  /// Get icon name for mistake type
  String get iconName {
    switch (this) {
      case MistakeType.tajweed:
